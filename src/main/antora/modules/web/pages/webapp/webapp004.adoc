...
The source code for this application is in the `_jakartaee-examples_/tutorial/web/servlet/hello2/` directory.
...
+
----
jakartaee-examples/tutorial/web/servlet/hello2/
----
...
----
+
This target builds the WAR file, copies it to the `_jakartaee-examples_/tutorial/web/hello2/target/` directory, and deploys it.
