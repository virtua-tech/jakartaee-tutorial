...
The source code for this application is in the `_jakartaee-examples_/tutorial/web/faces/hello1/` directory.
...
+
----
jakartaee-examples/tutorial/web/faces/hello1/
----
...
----
+
This command spawns any necessary compilations and creates the WAR file in `__jakartaee-examples_/tutorial/web/faces/hello1/target/`.
